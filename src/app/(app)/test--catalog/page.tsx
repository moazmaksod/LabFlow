...
export default function TestCatalogPage() {
  ...
  const TestForm = ({ test, onSave } : {test: Test, onSave: (test: Test) => void}) => {
            ...
            <div className="grid gap-6 py-4 max-h-[70vh] overflow-y-auto pr-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pl-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="minVolume" name="minVolume" type="number" placeholder="e.g. 3" value={currentTest.specimenRequirements.minVolume} onChange={(e) => setCurrentTest({...currentTest, specimenRequirements: {...currentTest.specimenRequirements, minVolume: parseFloat(e.target.value) }})} />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-4 border p-4 rounded-md">
                        <Label className="font-semibold">Routine</Label>
                         <div className="flex items-center gap-2">
                            <Input id="routineTime" type="number" placeholder="e.g., 24" value={currentTest.turnaroundTime.routine.value} onChange={(e) => setCurrentTest({...currentTest, turnaroundTime: {...currentTest.turnaroundTime, routine: {...currentTest.turnaroundTime.routine, value: parseInt(e.target.value) }}})} />
                     ...
                     <div className="space-y-4 border p-4 rounded-md">
                        <Label className="font-semibold">STAT</Label>
                         <div className="flex items-center gap-2">
                            <Input id="statTime" type="number" placeholder="e.g., 1" value={currentTest.turnaroundTime.stat.value} onChange={(e) => setCurrentTest({...currentTest, turnaroundTime: {...currentTest.turnaroundTime, stat: {...currentTest.turnaroundTime.stat, value: parseInt(e.target.value) }}})} />
                ...
                <Separator />
                 ...
                 <div className="space-y-2">
                    ...
                    <Input id="price" name="price" type="number" step="0.01" placeholder="e.g., 75.50" required value={currentTest.price} onChange={(e) => setCurrentTest({...currentTest, price: parseFloat(e.target.value)})} />
                </div>
